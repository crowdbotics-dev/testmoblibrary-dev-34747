...
## Project Structure
    ...
    ├── testmoblibrary_dev_34747  # Django project configurations
...
1. Clone this repo and `cd testmoblibrary_dev_34747`
...
2. Clone this repo and `cd testmoblibrary_dev_34747`
